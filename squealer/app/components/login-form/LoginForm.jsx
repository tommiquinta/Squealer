        ...
        <Card >
            <form className="flex flex-col py-4 px-8 gap-2.5">
                ...
                <div className="flex gap-2 justify-center">
                    <button type="button" onClick={handleLogin} className="shadow-sm shadow-slate-300 bg-socialBlue w-fit p-2 px-3 mt-3 -mb-3 ml-3 rounded text-white self-center">Login</button>
                    <button type="button" onClick={handleLogin} className="shadow-sm shadow-slate-300 w-fit p-2 px-3 mt-3 -mb-3 text-slate-400 rounded self-center">Login as Moderator</button>
                </div>
            </form>
        </Card>
    );
