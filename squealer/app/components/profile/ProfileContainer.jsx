...
export default function ProfileContainer({squeals, user, isMyUser, isModerator}){
    ...
    return(
        ...
        <BrowserRouter basename={`/profiles/${user?.username}`}>
            <Card noPadding={true}>
            ...
            <div className='z-20'>
                ...
                <div className='flex gap-2'>
                    ...
                    {isMyUser && (
                        <SectionButton name={"Private Channels"} isSelected={false}
                        destination={"/channels"}
                        icon={
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                <path fill="currentColor" d="M17.75 3a3.25 3.25 0 0 1 3.245 3.066L21 6.25v11.5a3.25 3.25 0 0 
                    ...
                    {isMyUser && (
                        <SectionButton name={"Settings"} isSelected={false}
