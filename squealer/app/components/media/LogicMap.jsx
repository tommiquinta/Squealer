...
import { Marker, Popup, TileLayer, LayersControl, useMapEvents } from 'react-leaflet'
                ...
                {flag === true ? (
                    <Popup minWidth={90}>
                        <span>
                            {markerPosition ? (
                                <span>
                                    <button onClick={() => handleSavePosition()}> Salva questa posizione</button> {/* Pulsante "Salva Posizione" */}
                                </span>
                            ) : (
                                'Posizionamento...'
                            )}
