...
export default function PostFilterContainer({allSqueals, loggedUser, channels}){
    ...
    function filters(text, channelId){
        if(text ==='' && channelId=='All channels'){
            ...
            if(channelId=='All channels'){
                ...
                setByChannel(channelId);
        }
    }

    return(
        <div className="flex">
            <PostList squeals={allSqueals} loggedUser={loggedUser} 
                hasFilter={withFilter} filterByChannel={byChannel} filterByContent={byContent}/>
