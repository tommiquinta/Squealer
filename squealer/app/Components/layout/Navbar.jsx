    ...
    <Card isNavbar={true}>
      <div className='px-4 py-2 w-screen md:w-fit '>
        ...
        {hasLoggedIn && (
            ...
            <NavbarButton name={'Users'} isActive={pathname === '/usersList'} url={'/usersList'} icon={
                <svg
              xmlns='http://www.w3.org/2000/svg'
              fill='none'
              viewBox='0 0 24 24'
            ...
            <NavbarButton name={'Your Profile'} isActive={() => asPath === userpage ? fetchUser() : null} url={userpage} icon={
