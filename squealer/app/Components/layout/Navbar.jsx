  ...
  return (
    ...
    <Card isNavbar={true}>
      <div className='px-4 py-2 w-screen md:w-fit '>
        ...
        {hasLoggedIn && (
          <div>
            ...
            <NavbarButton name={'Notifications'} isActive={false} url={'/'} children={
              ...
              <NavbarButton name={'Logout'} isActive={false} url={'/'} onClick={() => logout()} children={
                <svg
                xmlns='http://www.w3.org/2000/svg'
                fill='none'
                viewBox='0 0 24 24'
              ...
              >
                <path
                  strokeLinecap='round'
                  strokeLinejoin='round'
                  d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 
        ...
        {!hasLoggedIn && (
            <NavbarButton name={'Login'} isActive={false} url={'/login'} icon={
                <svg 
                xmlns="http://www.w3.org/2000/svg" 
                width="24" 
                height="24" 
